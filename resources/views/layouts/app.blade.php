...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('images/pr.png')}}" />
</head>
                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <a href="#" class="btn btn-dark text-white me-0"><i class="icon-download"></i> Export</a>
                    </div>
                  </div>
                </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="chartjs-wrapper mt-4">
                                  <canvas id="performaneLineBrown"></canvas>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="chartjs-bar-wrapper mt-3">
                                  <canvas id="marketingOverviewBrown"></canvas>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card card-rounded table-darkBGImg">
                              <div class="card-body">
                                <div class="col-sm-8">
                                  ...
                                  <a href="#" class="btn btn-primary upgrade-btn">Upgrade Account!</a>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  ...
                                  <div>
                                    <button class="btn btn-dark btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-account-plus"></i>Add new member</button>
                                  </div>
                                </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body card-rounded">
                                ...
                                <div class="list align-items-center pt-3">
                                  <div class="wrapper w-100">
                                    <p class="mb-0">
                                      <a href="#" class="fw-bold text-dark">Show all <i class="mdi mdi-arrow-right ms-2"></i></a>
                                    </p>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="col-lg-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                      ...
                                      <div class="add-items d-flex mb-0">
                                        ...
                                        <button class="add btn btn-icons btn-rounded btn-dark todo-list-add-btn text-white me-0 pl-12p"><i class="mdi mdi-plus"></i></button>
                                      </div>
                                    </div>
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <canvas class="my-auto" id="doughnutChartBrown" height="200"></canvas>
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3">
                                      <canvas id="leaveReportBrown"></canvas>
                                    </div>
                                  </div>
                                </div>
                              </div>
