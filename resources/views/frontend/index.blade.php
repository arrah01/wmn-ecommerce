            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    <div class="categories__text">
                        ...
                        <a href="{{route('catergories')}}">Shop now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row property__gallery">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('storage/product_pic/'. $new->image ) }}">
                        <div class="label new">New</div>
                        <ul class="product__hover">
                            <li><a href="{{ asset('storage/product_pic/'. $new->image ) }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="product__price">${{$new->selling_price}}</div>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-8 m-auto">
                <div class="banner__slider owl-carousel">
                    ...
                    <div class="banner__item">
                        <div class="banner__text">
                            <span>The smart Collection</span>
                            <h1>The look</h1>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 mt-3">
                <div class="card product__item">
                    <img src="{{ asset('storage/product_pic/'. $feature->image ) }}">
                    <ul class="product__hover">
                        <li><a href="{{asset('storage/product_pic/'. $feature->image ) }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                        <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                    </ul>
                    <div class="card-body product__item__text">
                        ...
                        <div class="product__price">${{$feature->selling_price}}<span>$ {{$feature->original_price}}</span></div>
                    </div>
                </div>
            </div>
            @endforeach
